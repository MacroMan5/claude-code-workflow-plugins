...
def should_block_completion(test_info: dict, enforce_tdd: bool = False, min_tests: int | None = None) -> tuple[bool, str]:
    """
...
def log_stop_event(session_id: str, input_data: dict, test_info: dict, blocked: bool, reason: str) -> None:
    """
...
def main():
    ...
    try:
        ...
        should_block, reason = should_block_completion(test_info, enforce_tdd=enforce, min_tests=min_tests_val)
        ...
        if should_block:
            ...
            output = {
                ...
                'failures': test_info['test_failures'][:5] if test_info['test_failures'] else [],
